...
public class GradesFragment extends Fragment {
    ...
    AppDB db;//CREATE DB VAR

    public void getGrades(){//GET THE WANTED ITEMS
        db = Room.databaseBuilder(getActivity(), AppDB.class, "grades-db")
                .fallbackToDestructiveMigration().allowMainThreadQueries()
                .build();

        mGrades = (ArrayList<Grade>) db.gradesDao().getAll();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getGrades();//CALL THE GET GRADES METHOD HERE
        ...
        class GradeViewHolder extends RecyclerView.ViewHolder{
            ...
            public void setupUI(Grade grade){
                ...
                mBinding.imageViewDelete.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {//HERE IS THE DELETION PROCESS
                    db.gradesDao().delete(mGrade);
                    getGrades();
                    }
                });
            }
